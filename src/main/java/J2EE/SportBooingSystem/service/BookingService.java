...
public interface BookingService {
    ...
    BookingStatus cancelBooking(Long bookingId, String userEmail, String reason);
    ...
    void confirmBooking(Long bookingId, String ownerEmail);
    void approveCancelRequest(Long bookingId, String ownerEmail, boolean approve);
}
